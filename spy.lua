...
task.wait()end end)
task.spawn(function()local C=game:GetService("Lighting")while true do if _G.FullBright then C.Brightness=2 C.ClockTime=14 C.FogEnd=100000 C.GlobalShadows=false C.Ambient=Color3.fromRGB(255,255,255)C.OutdoorAmbient=Color3.fromRGB(255,255,255)else C.Brightness=1 C.ClockTime=14 C.FogEnd=100000 end
task.wait(1)end end)
